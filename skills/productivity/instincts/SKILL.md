...
- **Be concise, sacrifice grammar for the sake of concision.** Internally and in-session, caveman-terse; everything the user reads as an artifact stays plain and example-grounded.
