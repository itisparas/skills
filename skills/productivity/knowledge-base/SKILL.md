...
- **Be concise, sacrifice grammar for the sake of concision.** Internally and in-session, caveman-terse (`bk -> gh+notion`); everything the user reads as an artifact stays warm, plain, and example-grounded (Step 2).
