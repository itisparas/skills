...
| `state:human-review-needed` | Findings, open questions, or a raw idea needing triage need human judgement (untyped issue = the `ideate` triage case) | `ideate`, `review-pr`, `create-prd`, `slice-prd` | humans |
